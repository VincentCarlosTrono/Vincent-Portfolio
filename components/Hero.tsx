    ...
    <section className="grid-container">
      <main className="col-start-2 col-end-3 text-center sm:text-left">
        <div className="max-w-lg my-36 text-gray-800 ">
          ...
          <p className="text-sm sm:text-base mb-2 text-gray-700 max-w-md">
          ...
          <p className="text-sm sm:text-base text-gray-700 max-w-md">
            I started web development in 2018, after doing Front-end, I switched
            to Full Stack development, where I work with a variety of meaningful
            projects.
          </p>
